...
def get_commits(BASE_URL, KEY, OWNER, REPO, commits, pull, USERNAME, TOKEN):
...
def get_pulls(BASE_URL, KEY, OWNER, REPO, pulls, SEARCH, STATE, USERNAME, TOKEN, field_list):
    pulls_list = []
    max_pages = pages(BASE_URL, SEARCH, STATE, USERNAME, TOKEN)
...
def df_status(df_pulls, BASE_URL, KEY, OWNER, REPO, commits, USERNAME, TOKEN, field_list):
